    ...
    <section class="aui-scrollView">
      ...
      <div class="aui-chang-list">
        <div class="aui-user-img">
          <img style="width:100%;height:100%;" :src="$store.state.user.detail.profile.avatarUrl" alt="" />
        </div>
        <div class="aui-user-text">
          <h1>{{$store.state.user.detail.profile.nickname}}</h1>
          <span v-if="$store.state.user.detail.profile.vipType==0"><i class="icon icon-vip"></i>您还未开通VIP</span>
          <button>开通会员</button>
        </div>
      </div>
      ...
      <div class="aui-list-item">
        ...
        <a href="javascript:;" class="aui-flex b-line" @click="exit">
          <div class="aui-cou-img">
            <img src="@/assets/icon-005.png" alt="" />
          </div>
          <div class="aui-flex-box">
            <p>退出登录</p>
          </div>
